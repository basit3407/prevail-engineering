          ...
          <Grid container>
            <Grid item sm={12} md={6}>
              ...
              <Typography variant="body1" className={classes.aboutParagraph}>
                ...
                and support to our valued clients. As per the requirement, we
                form joint ventures with other reputed consulting firms and
                clients to provide services in diverse areas. We offer a full
                spectrum of Electrical, Mechanical and Plumbing solutions to
                virtually all sectors.
              </Typography>

              <Typography variant="body1" className={classes.aboutParagraph}>
                <strong>PREVAIL ENGINEERING</strong> is an independent business
                entity, serving a diversified client base, ranging from cable
                laying to Building Management Systems, Fire Alarm Systems, CCTV,
                Telecommunication System, Firefighting System and HVAC Ducting
